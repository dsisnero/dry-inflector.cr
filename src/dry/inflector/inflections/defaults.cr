  ...
  class Inflector
    class Inflections
      ...
      module Defaults
        # @since 0.1.0
        # @api private
        protected def self.call(inflect)
          plural(inflect)
          singular(inflect)
          irregular(inflect)
          uncountable(inflect)
        ...
        # @since 0.1.0
        # @api private
        private def self.plural(inflect)
          inflect.plural(/\z/, "s")
          ...
          puts "inflect.inspect"
        end

        # @since 0.1.0
        # @api private
        private def self.singular(inflect)
        ...
        # @since 0.1.0
        # @api private
        private def self.irregular(inflect)
        ...
        # @since 0.1.0
        # @api private
        private def self.uncountable(inflect)
        ...
        # @since 0.1.2
        # @api private
        private def self.acronyms(inflect)
